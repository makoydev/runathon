...
export function CurrentLoadInputs({
  ...
  return (
    <section className="bg-white/70 backdrop-blur-sm p-6 rounded-xl border border-slate-200 shadow-sm space-y-4">
      <div>
        <h2 className="text-lg font-semibold text-slate-700">Current Training Load</h2>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <label className="block">
          <span className="block text-sm font-medium text-slate-600 mb-2">Current weekly mileage</span>
        ...
        <label className="block">
          <span className="block text-sm font-medium text-slate-600 mb-2">Longest recent run</span>
          <div className="flex items-center gap-2">
            <input
              type="text"
              inputMode="decimal"
